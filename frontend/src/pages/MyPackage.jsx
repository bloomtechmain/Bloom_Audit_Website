...
import { FaBoxOpen, FaCheckCircle, FaHourglassHalf, FaEdit, FaCheck, FaArrowLeft } from 'react-icons/fa';
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="flex-grow container mx-auto px-4 py-24">
        ...
        {!isEditing ? (
          ...
          >
            <div className="bg-gradient-to-r from-[#0e3b5e] to-[#00cba9] p-10 text-white flex justify-between items-center relative overflow-hidden">
              <div className="relative z-10">
                 <h2 className="text-3xl font-bold">Current Plan</h2>
                 <p className="opacity-90 mt-1">Next billing date: {new Date().toLocaleDateString()}</p>
              </div>
